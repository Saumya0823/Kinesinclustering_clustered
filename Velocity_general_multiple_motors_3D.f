	...
	open(unit=21,file="Rate_V_clusmot_D1_N10.dat")
        open(unit=23,file="V_clusmot_D1_N10.dat")
        open(unit=20, file="V_confare_clusmot_D1_N10.dat")
        open(unit=22, file="V_avgarea_clusmot_D1_N10.dat")
        open(unit=24, file="V_clus_rate_clusmot_D1_N10.dat")
