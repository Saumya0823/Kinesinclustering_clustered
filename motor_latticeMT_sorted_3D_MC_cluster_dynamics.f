	Program iargorotationunderexternalforce
	parameter (N=10)
	real Lo
...
c        open(unit=10,file="Torque_clusmotran_N5_D001.dat")
c        open(unit=11,file="angle_clusmotran_N5_D001.dat")
c        open(unit=22,file="Rate_clusmotran_N5_D001.dat")
c        open(unit=23,file="RLV_clusmotran_N5_D001.dat")
        open(unit=20, file="motor_tails_clusmotran_N10_D001.dat")
        open(unit=21, file="time_points_clusmotran_N10_D001.dat")
...
c          end if
c
c	  angle_sum= angle_sum+ angle(1)
c          angle_sum1= angle_sum1+ angle(2)
c          angle_sum2= angle_sum2+ angle(3)
c
c          for_var= sqrt(sumF_x**2 +sumF_y**2 +sumF_z**2)
c          Fsum= Fsum + for_var
c          Fxsum= Fxsum + sumF_x
c          Fysum= Fysum + sumF_y
c          Fzsum= Fzsum + sumF_z
c	
