...
c        open(unit=10,file="Torque_clusran_N10_D001.dat")
c        open(unit=11,file="angle_clusran_N10_D001.dat")
c        open(unit=22,file="Rate_clusran_N10_D001.dat")
c        open(unit=23,file="RLV_clusran_N10_D001.dat")
        open(unit=20, file="motor_tails_clusran_N5_D001.dat")
        open(unit=21, file="time_points_clusran_N5_D001.dat")
