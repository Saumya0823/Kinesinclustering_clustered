	Program ratiorates
	open(unit=21, file= "Rate_V_clus_motran_D001_N10.dat")
        open(unit=22, file= "Rate_V_clus_motran_D01_N10.dat")
        open(unit=24, file= "Rate_V_clus_motran_D1_N10.dat")
	open(unit=23, file= "ratios_rates_clusmotran_V_N10_F0.dat")
